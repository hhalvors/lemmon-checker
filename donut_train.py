...
from transformers import DonutProcessor, VisionEncoderDecoderModel, Seq2SeqTrainer, Seq2SeqTrainingArguments, default_data_collator
import torch
...
trainer = Seq2SeqTrainer(
    ...
    data_collator=collate_fn,  # <- THIS LINE
)
